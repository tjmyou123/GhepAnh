...
- 15 bố cục: justified, grid, mosaic, masonry, hero, polaroid, stack, timeline, timeline-doc, process, path, steps, filmstrip, string, hexagon
- 10 theme màu, tuỳ biến chi tiết infographic (số thứ tự, nhãn, màu trục…)
- Trình chiếu ảnh tự động hiệu ứng zoom (Ken Burns) xuất HTML/PowerPoint
